// stb_textedit.h - v1.0  - public domain - Sean Barrett
...
// texts, as it does not scale and has limited undo).
//
...
//
//    STB_TEXTEDIT_K_SHIFT       a power of two that is or'd in to a keyboard input to represent shift
//
