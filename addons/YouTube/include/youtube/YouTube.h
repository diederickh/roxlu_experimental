...
class YouTube {
 public:
  ...
  void setUploadProgressCallback(youtube_upload_progress_callback progressCB);        /* set the function which will be called while uploading; this function should return 0 to continue uploading, if  you want to stop uploading let it return 1 */
  void setCallbackData(void* user);                                                   /* set the user data which gets passed into the callbacks (e.g. the upload progress) */
 ...
 public:                                                                              
  ...
  void* cb_user;                                                                      /* gets passed into the callbacks */
};
